...
const validUser = { password: 'secret', lastName: 'singh', firstName: 'dapinder', email: 'dev.dapinder@gmail.com' };
...
describe('************* AUTH REGISTRATION *************', () => {
  ...
  it('should FAIL [422] to create a user with incomplete parameters', (done) => {
    request(app)
      ...
      .set('X-Real-IP', URI)
      .type('form')
      .send({ email: 'dev.dapinder@gmail.com', lastName: 'singh', firstName: 'dapinder' })
      .expect(422)
      .end((err, res) => {
        if (err) done(err);
